...
P('R90-R83-CACHE-02',/const V = 447;/.test(server)&&/fob-shell-v447/.test(fs.readFileSync(path.join(root,'sw.js'),'utf8')),
  'R90 intentionally advances the shell identity while preserving every R83 Mr.Mah visibility/material contract');
