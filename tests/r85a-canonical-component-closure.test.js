...
const checks=[
  ...
  [coachCss.includes("@import url('/mahfitt-canonical-components.css?v=452')"),'Admin crown imports shared canonical owner'],
  [adminCss.includes("@import url('/mahfitt-canonical-components.css?v=452')"),'FOB Admin imports shared canonical owner'],
