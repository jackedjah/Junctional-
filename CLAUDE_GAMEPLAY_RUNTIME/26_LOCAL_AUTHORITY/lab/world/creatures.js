...
var TAG = { lift_m: 0.2, tint: '#6e9dff', name: 'DOGKIE' };   /* owner B7 §3: the shared overhead status (NAME · LV · HP) replaces the damaged-only label sprite; a Dogkie always shows its level / health while active nearby */
