...
- Asset restore uses the original `ASSET_BACKUP_MANIFEST.json` plus `CLAUDE_MAP_ASSET_SUPPLEMENT.json`; verified checkpoint `2d41d494853017add0865de4dfc645d06e66e7f8` closes the current registry's gym/training-display runtime-asset gap.
